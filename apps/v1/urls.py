...
from apps.users.views import (
    ...
    CsrfBootstrapView,
    CustomerCookieLoginView,
    CustomerCookieLogoutView,
    CustomerCookieRefreshView,
    LoginView,
    LogoutView,
...
urlpatterns = [
    ...
    path("auth/customer/login/", CustomerCookieLoginView.as_view(), name="customer_cookie_login"),
    path("auth/customer/refresh/", CustomerCookieRefreshView.as_view(), name="customer_cookie_refresh"),
    path("auth/customer/logout/", CustomerCookieLogoutView.as_view(), name="customer_cookie_logout"),
