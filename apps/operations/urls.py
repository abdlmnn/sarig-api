...
from .views import (
    ...
    AdminOnboardingDecisionView,
    AdminOnboardingSummaryView,
    AdminRiderListView,
...
urlpatterns = [
    ...
    path("onboarding/summary", AdminOnboardingSummaryView.as_view(), name="admin-onboarding-summary"),
    path("onboarding/applications/<str:application_id>/decision", AdminOnboardingDecisionView.as_view(), name="admin-onboarding-decision"),
