...
urlpatterns = [
    ...
    path("merchants/<uuid:store_id>/action", AdminMerchantActionView.as_view(), name="admin-merchant-action"),
    path("riders", AdminRiderListView.as_view(), name="admin-riders"),
    path("riders/<uuid:rider_id>/action", AdminRiderActionView.as_view(), name="admin-rider-action"),
