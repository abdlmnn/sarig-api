...
from .views import (
    ...
    AdminResendChangeRequestView,
    AdminResendSetupInvitationView,
...
urlpatterns = [
    ...
    path("accounts/setup/<str:token>/", AccountSetupView.as_view(), name="account-setup"),
    ...
    path(
        "applications/<str:application_id>/resend-setup/",
        AdminResendSetupInvitationView.as_view(),
        name="onboarding-application-review-resend-setup",
    ),
    path(
        "applications/<str:application_id>/resend-changes/",
        AdminResendChangeRequestView.as_view(),
        name="onboarding-application-review-resend-changes",
    ),
